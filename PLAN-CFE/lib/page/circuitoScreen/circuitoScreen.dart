...
class _CircuitoDetailScreenState extends State<CircuitoDetailScreen> {
  ...
  Future<Circuito> fetchCircuito() async {
    ...
    final response = await Dio().get(
      'https://apicfe.onrender.com/api/numcircs/${widget.id}',
      options: Options(
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Circuito>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          final imageBase64 = snapshot.data!.circuito!.diagrama.split(',').last;
          final imageBytes = base64Decode(imageBase64);
          return Scaffold(
            appBar: AppBar(
              title: Text(snapshot.data!.circuito!.nombre),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    // Ubicaciones
                    ...snapshot.data!.circuito!.ubicaciones.map((ubicacion) {
                      return Card(
                        elevation: 2,
